...
import { ResponseCookies } from '@neumatter/cookie-jar'
...
export default class NeuResponse extends ServerResponse {
  ...
  send (message) {
    ...
    if (!testType) this.set(MIME.CONTENT_TYPE, MIME.HEADERS.TXT)
